...
class InverseKinematicsWithManyMovingObstacles(Manipulation, abc.ABC):
    ...
    # Define the obstacle 0
    _obstacle_enable: bool =True
    _obstacle_type: str = 'box'
    _obstacle_dimensions: List[float] = [0.1, 0.1, 0.1]
    ...
    _obstacle_count = 3
    #IF obstacle count to high, the following error is thrown: ODE INTERNAL ERROR 1: assertion "aabbBound >= dMinIntExact && aabbBound < dMaxIntExact" failed in collide() [collision_space.cpp:460]
